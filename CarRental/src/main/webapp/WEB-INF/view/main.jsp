...
<div class="container px-4 py-5" id="featured-3">
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <div class="feature col" align="center">
            ...
            <p align="center" font-size="15px">Катайся на автомобиле, скололько угодно.<br> Никаких дополинтельных оплат за перепробег</p>
        </div>
        ...
        <div class="feature col" align="center">
            ...
            <p align="center" font-size="15px">Если вы найдете цену на аналогичный автомобиль в другом прокате ниже - мы сделаем еще дешевле!</p>
        </div>
    </div>
</div>
