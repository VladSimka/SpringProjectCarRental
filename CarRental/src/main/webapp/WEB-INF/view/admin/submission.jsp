...
<c:forEach var="request" items="${endingRequests}">
    <hr class="featurette-divider">
    <div class="row featurette justify-content-center" align="center">
            ...
            <div class="mt-auto">
                <div class="row justify-content-center">
                    <div class="col-md-3 text-center">
                        <form action="/admin/end-of-requests/${request.id}" method="post">
                            <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                            <button type="submit" class="btn btn-success me-3">Принять машину</button>
                        </form>
                    </div>

                    <div class="col-md-3 text-center">
                        <form action="/admin/end-of-requests/scratches/${request.id}" method="post">
                            <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                            <button type="submit" class="btn btn-danger me-3">Принять машину + штраф за царапины
                            </button>
                        </form>
                    </div>

                    <div class="col-md-3 text-center">
                        <form action="/admin/end-of-requests/dirt/${request.id}" method="post">
                            <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                            <button type="submit" class="btn btn-danger me-3">Принять машину + штраф за грязь</button>
                        </form>
                    </div>
                </div>
            </div>
