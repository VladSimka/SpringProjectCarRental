...
<head>
    ...
    <link href="<c:url value="/resources/css/checkout.css"> </c:url>" rel="stylesheet">
</head>
<body>
            ...
            <form:form action="/done" modelAttribute="creditCard" cssStyle="align-content:center" method="get">
                <div class="row justify-content-center" align="center">
                    ...
                    <div class="col-md-6">
                        ...
                        <form:input class="form-control" path="number" id="cc-number"/>
                ...
                <div class="row justify-content-center" align="center">
                    <div class="col-md-3">
                        ...
                        <form:input class="form-control" path="expiration" id="cc-expiration"/>
                        <form:errors path="expiration"/>
                    </div>

                    <div class="col-md-3">
                        <label for="cc-cvv" class="form-label">CVV</label>
                        <form:input class="form-control" path="CVV" id="cc-cvv"/>
                        <form:errors path="CVV"/>
                    </div>
                </div>

                <br class="my-4">
                <button class="w-50 btn btn-primary btn-lg" type="submit">Оплата</button>
            </form:form>
        </div>
